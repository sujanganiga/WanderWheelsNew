      ...
      <BrowserRouter>
        ...
        <ChatBot
          ...
          steps={[
            {
              id: '1',
              message: 'Welcome to our Car Rental Assistance. How can I help you today?',
              trigger: '2',
            },
            {
              id: '2',
              options: [
                { value: 'filter', label: 'I want to apply filters for my rental', trigger: 'apply_filters' },
                { value: 'baby_sitter_car', label: 'I need a car with baby sitter features', trigger: 'baby_sitter_car' },
                { value: 'home', label: 'Go back to Home', trigger: 'home' }
              ],
            },
            {
              id: 'apply_filters',
              message: 'Sure, please specify your filters like location, date, and type of car you are looking for.',
            ...
            {
              id: 'filtered_results',
              message: 'Here are the filtered results based on your preferences.',
              end: true,
            },
            {
              id: 'baby_sitter_car',
              message: 'Great! We have cars equipped with baby sitter features. Please specify your requirements if any.',
            ...
            },
            {
              ...
              message: 'Here are the cars suitable for you and your baby. You can find more details on our Home page.',
              end: true,
            },
            {
              id: 'home',
